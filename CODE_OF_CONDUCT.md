...
This Code of Conduct is adapted from the [Contributor Covenant][URL_COVENA],
specifically its [version 2.1][URL_COVV21]. For answers to common questions
about this code of conduct or other languages, see the [FAQ][URL_COVFAQ] and
[translations][URL_COVTRA].
